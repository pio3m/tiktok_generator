...
from moviepy.editor import (
    ...
    concatenate_videoclips, ColorClip, CompositeAudioClip, VideoFileClip
)
...
# --- ŚCIEŻKI ---
background_path = "../data/obraz.png"  # lub background.mp4 jeśli chcesz video
...
def get_timer_clips():
    ...
    for i in range(5, 0, -1):
        t_clip = TextClip(
            ...
            stroke_width=5,
            method="caption"
        ).set_duration(1).set_position(("center", "center")).fadein(0.2).fadeout(0.2)
...
final.write_videofile(f"../output/{filename}", fps=FPS)
